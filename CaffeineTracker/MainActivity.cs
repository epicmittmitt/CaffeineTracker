...
namespace CaffeineTracker
{
	...
	public class MainActivity : Activity
	{
		...
		private void UpdateListView()
		{
			...
			var totalCaffeine = drinks.Sum(_ => _.Caffeine);
			var remainingCaffeine = drinks.Sum(_ => _.ComputeCaffeine);
			FindViewById<TextView>(Resource.Id.textView2).Text = totalCaffeine + " mg";
			FindViewById<TextView>(Resource.Id.textView8).Text = Math.Round(remainingCaffeine, 2) + " mg";
			FindViewById<ProgressBar>(Resource.Id.progressBar1).Progress = (int)(remainingCaffeine / 400 * 100);
			//lv.ItemClick += (s, e) => { };
